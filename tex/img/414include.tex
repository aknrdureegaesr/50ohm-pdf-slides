...
\draw[->,arrows=-triangle 60] (in) -- (d);
\draw[->,arrows=-triangle 60] (d) -- (a);
\draw[->,arrows=-triangle 60] (a) -- (b);
\draw (b.south) node [below,align=center] {mittels\\ Sprachcodec};
\draw[->,arrows=-triangle 60] (b) -- (c);
\draw (c.south) node [below,align=center] {Redundanz\\ zur\\ Fehlerkorrektur};
\draw[->,arrows=-triangle 60] (c) -- (e);
