...
\begin{circuitikz}[european]
    ...
    \draw(m1)
        ...
        to [short] ++(0,-1.5)
        to [vR, l={$R_3$}, a={\rotatebox[origin=c]{90}{\qty{220}{\mathrm{\ohm}}}}, name={r3},invert, mirror, tunable end arrow={Bar}] ++(0,-1.5) coordinate(c1)
        to [R, a={\rotatebox[origin=c]{90}{$R_6$=\qty{150}{\mathrm{\ohm}}}},-*] (c1|-u0);
    \draw(r3.wiper)
        to [short,-*] ++(1,0) coordinate(c2)
        to [short] (c2|-c1) coordinate(c3)
        to [R, a={\rotatebox[origin=c]{90}{$R_4$=\qty{6,8}{\kilo\mathrm{\ohm}}}},-*] (c3|-u0);
    \draw(c2)
        to [short] ++(1.75,0) coordinate(c4)
        to [C, a={\rotatebox[origin=c]{90}{$C_4=\qty{100}{\nano\farad}$}},-*] (c4|-u0);
    \draw(c2)
        to [R, l={$R_5$}, a={\rotatebox[origin=c]{90}{\qty{51}{\mathrm{\ohm}}}}] ++(0,5)
    ...
    \draw(T1.B2)
        to [short] ++(2,0)
        node[nigfete, solderdot, yscale=-1, anchor=G](K2){\ctikzflipy{Transistor$_2$}};
