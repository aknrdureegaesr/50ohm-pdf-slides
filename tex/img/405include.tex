...
\begin{tikzpicture}
    ...
    \addplot[samples=51,domain=0.9+0.05:1.1-0.055,smooth] {20+10*log10(0.5-0.5*cos(deg(x+0.055)*10*pi))}; 
	\addplot[samples=81,domain=1.1-0.055:1.90+0.055,smooth] {20+0}; 
	\addplot[samples=51,domain=1.9+0.055:2.0+0.055,smooth] {20+10*log10(0.5-0.5*cos(deg(x-0.055)*10*pi))}; 
