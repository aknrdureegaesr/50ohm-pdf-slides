...
\begin{tikzpicture}
    ...
    \addplot[samples=51,domain=1.9+0.05:2.1-0.055,smooth] {20+10*log10(0.5-0.5*cos(deg(x+0.055)*10*pi))}; 
	\addplot[samples=81,domain=2.1-0.055:2.90+0.055,smooth] {20+0}; 
	\addplot[samples=51,domain=2.9+0.055:3.0+0.055,smooth] {20+10*log10(0.5-0.5*cos(deg(x-0.055)*10*pi))}; 
